...
class TypeProto_Map PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  ::onnx::TensorProto_DataType _internal_key_type() const;
  void _internal_set_key_type(::onnx::TensorProto_DataType value);
  public:
...
inline ::onnx::TensorProto_DataType TypeProto_Map::_internal_key_type() const {
...
inline void TypeProto_Map::_internal_set_key_type(::onnx::TensorProto_DataType value) {
  assert(::onnx::TensorProto_DataType_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  key_type_ = value;
}
...
inline ::onnx::TensorProto_DataType TypeProto_SparseTensor::_internal_elem_type() const {
  return static_cast< ::onnx::TensorProto_DataType >(elem_type_);
}
...
inline void TypeProto_SparseTensor::_internal_set_elem_type(::onnx::TensorProto_DataType value) {
  assert(::onnx::TensorProto_DataType_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  elem_type_ = value;
}
